    ...
    <div class="contacts-box-container">
        ...
        <div id="contact-container" class="contact-container" style="border-top:2px solid #ddd;">
            ...
            if(isset($_POST['submit'])){
                ...
                $sqlu = "UPDATE `users` SET `About`='$new_bio' WHERE `UserName`='$user' ";
                if(mysqli_query($conn, $sqlu)){
                    header("location:settings.php");
                }else{
                    ?><div class="php-response-container"><?php echo "Bio Change Failed"; ?></div><?php
                }
            }
            ?>
            <br>
            <form action="change_bio.php" method="post">
                <input type="text" name="new_bio" id="new_bio" placeholder="New Bio..." autocomplete="off" autofocus required><br><br>
